    ...
    counter: function (options) {
      ...
      var methods = {
        ...
        setMsg: function () {
          ...
          if (noLimit) {
            return options.msg !== "" ? options.msg : "";
          }
          this.text = options.translation || "word left max";
          ...
          switch (options.type) {
            case "char":
              if (options.count === defaults.count && options.text) {
                this.msg = this.text[0] + this.chars[1] + options.goal + " " + this.text[2] + this.chars[2];
              } else if (options.count === "up" && options.text) {
                this.msg = this.text[0] + this.chars[0] + " " + this.chars[1] + options.goal + " " + this.text[2] + this.chars[2];
              }
              break;
            case "word":
              if (options.count === defaults.count && options.text) {
