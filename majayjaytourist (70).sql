...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2024 at 05:24 AM
...
(4, 128, '', '', '', '2024-11-14 16:16:08', 0, 0, 0, 0, 0, 0, 0),
(5, 128, 'Hdjdjd', 'Female', 'Other Province', '2024-11-14 16:16:21', 1, 0, 1, 0, 0, 1, 0),
(6, 128, 'Ususs', 'Male', 'Other Province', '2024-11-14 16:16:52', 1, 1, 0, 0, 0, 1, 0),
(7, 128, 'Hxhdhd, Hdhdhd, Hdhdhd, Udhdhdhd, Hdhdhd', 'Male, Male, Male, Male, Female', 'Other Province, Foreign Country, Foreign Country, Foreign Country, Other City/Municipality', '2024-11-14 16:18:47', 5, 4, 1, 0, 1, 1, 3),
(8, 131, 'John, Cyril', 'Male, Male', 'This City/Municipality, This City/Municipality', '2024-11-19 06:50:14', 2, 2, 0, 2, 0, 0, 0),
(9, 131, 'John, Cy, Jon', 'Male, Male, Male', 'This City/Municipality, Other Province, Other City/Municipality', '2024-11-19 06:52:46', 3, 3, 0, 1, 1, 1, 0);
...
(27, 53, 'johnarganosa@gmail.com', '$2y$10$Yh81aF.GNKIOYGugAuH2WOu1qmck4d1uaOE8W75OHNkDDdFncD0eu', '2024-11-19 07:02:50', 1);
...
(48, 'Jordano Igop', 'jordanao98@shurua.xyz', '+634523523523', 'sadasdasdsa', 'otherCity', 'male', 'passport', '../../user/userID/Igop/Igop_48_front.jpg', NULL, '2024-11-13 00:12:11'),
(49, 'bading Kaba', 'badingksu78@shurua.xyz', '+637326478236', 'khaskdhasdas', 'otherCity', 'male', 'national_id', '../../user/userID/Kaba/Kaba_49_front.jpg', NULL, '2024-11-13 00:17:34'),
(50, 'Poknat Kuba', 'poknaykjsd87@shurua.xyz', '+638923749873', 'k12321 Street', 'thisCity', 'male', 'driver_license', '../../user/userID/Kuba/Kuba_50_front.jpg', NULL, '2024-11-14 16:37:49'),
(51, 'kunaysila kapabas', 'kjasd897@shurua.xyz', '+632374893274', 'hjksahds Street', 'otherCity', 'male', 'passport', '../../user/userID/kapabas/kapabas_51_front.jpg', NULL, '2024-11-14 16:39:42'),
(52, 'Kuya Jason', 'kuyajason00@shurua.xyz', '+638937249872', '1212 Street', 'otherCity', 'female', 'Postal ID', '../../user/userID/Jason/Jason_52_front.jpg', NULL, '2024-11-18 09:14:43'),
(53, 'John Cyril Arganosa', 'johnarganosa@gmail.com', '+639834758973', '121 Street , Majayjay Laguna', 'thisCity', 'male', 'Postal ID', '../../user/userID/Arganosa/Arganosa_53_front.png', NULL, '2024-11-19 07:02:50');
...
--
ALTER TABLE `bownerdemographics`
  MODIFY `bOwnerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `businessapplicationform`
--
ALTER TABLE `businessapplicationform`
  MODIFY `ApplicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;

--
-- AUTO_INCREMENT for table `businessinformationform`
--
ALTER TABLE `businessinformationform`
  MODIFY `BusinessInfoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
