...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2024 at 11:53 PM
...
(97, 69, 52, 'Kuya Jason', '1212 Street', 'kuyajason00@shurua.xyz', '+638937249872', '2024-12-03', '2024-12-04', 'REF-PTQBFD', '2024-11-28 21:57:54', 'Pending');
...
(77, 119, 'Robert Martin', 12.00, 12, 121, '* Bawal Tambay\r\n* Bawal Inom\r\n* Bawal Tumingin', '../../businessowner/roomImages/Mario Tupar Resort/Robert Martins/isa_674c5bc2963fa.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Robert Martin/zoshua-colah-LZiErjGyaYQ-unsplash_674c1ca1ed513.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Robert Martins/zoshua-colah-MPCcoBQkVyg-unsplash_674c4464baad4.jpg', NULL, NULL, NULL, '19:23:00', '07:24:00');
...
(1, 52, 69, 119, 'Jordan Rae Marabe, John Rev Baliton', 'Male, Male', 'This City/Municipality, Foreign Country', '2024-11-28 13:57:54', 2, 2, 0, 1, 0, 0, 1, 'Pending');
...
(61, 69, 119, 52, 0, '../../businessowner/userPaymentProof/QRCode (4).png', '21321312312');
...
--
ALTER TABLE `payment_methods`
  MODIFY `paymentMethodID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `reservations`
  MODIFY `revID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `userdemographics`
  MODIFY `userdemogId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `userpayment`
--
ALTER TABLE `userpayment`
  MODIFY `userpayID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `userdemographics`
  ADD CONSTRAINT `userdemographics_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`userId`) ON DELETE CASCADE,
  ADD CONSTRAINT `userdemographics_ibfk_2` FOREIGN KEY (`roomID`) REFERENCES `roominfotable` (`roomID`) ON DELETE CASCADE,
  ADD CONSTRAINT `userdemographics_ibfk_3` FOREIGN KEY (`BusinessInfoID`) REFERENCES `businessinformationform` (`BusinessInfoID`) ON DELETE CASCADE;
