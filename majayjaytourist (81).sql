...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2024 at 03:45 AM
...
CREATE TABLE `reservations` (
  ...
  `status` enum('Pending','Accepted','Ongoing','Rejected','Cancel') NOT NULL DEFAULT 'Pending',
...
(30, 2, 52, 'Kuya Jason', '1212 Street', 'kuyajason00@shurua.xyz', '+638937249872', '2024-12-11', '2024-12-12', 'REF-KKUL7F', '2024-12-10 18:17:47', 'Accepted', NULL),
(31, 2, 53, 'Kuya Jason', '299 San Pedro Street Brgy I, Alaminos Laguna', 'kuyajason01@shurua.xyz', '+635656756753', '2024-12-20', '2024-12-21', 'REF-URX2VP', '2024-12-10 19:59:31', 'Accepted', NULL),
(32, 2, 54, 'John Smith', '123 St., Brgy. Barangay, Municipality City, Province province', 'eaanives04@gmail.com', '+639917847770', '2024-12-24', '2024-12-25', 'REF-14G0NE', '2024-12-10 22:35:11', 'Accepted', NULL),
(33, 1, 53, 'Kuya Jason', '299 San Pedro Street Brgy I, Alaminos Laguna', 'kuyajason01@shurua.xyz', '+635656756753', '2024-12-13', '2024-12-14', 'REF-HOVM77', '2024-12-11 10:07:12', 'Pending', NULL);
...
(1, 119, 'Torres Farm', 7000.00, 12, 5, '* Bawal Tumalon\r\n* Bawal Kumain\r\n* Bawal Mag-inom', '../../businessowner/roomImages/Mario Tupar Resort/Torres Farm/we-do-creative-films-WT6ug4AzKUo-unsplash_6755651721e02.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Torres Farm/zoshua-colah-LZiErjGyaYQ-unsplash_6755651721fe1.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Torres Farm/zoshua-colah-MPCcoBQkVyg-unsplash_675565172210a.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Torres Farm/zoshua-colah-OBW7Ag4Da-4-unsplash_6755651722217.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Torres Farm/zoshua-colah-XE4TRyh4g7k-unsplash_6755651722370.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Torres Farm/we-do-creative-films-WT6ug4AzKUo-unsplash_67556517224c0.jpg', '07:22:00', '20:20:00'),
(2, 119, 'Resort na Talaga', 2000.00, 1, 1, '* Bawal lahat\r\n* Bawal nga aba\r\n* Bawal hindi naligo', '../../businessowner/roomImages/Mario Tupar Resort/Resort na Talaga/Falls_67579e2c2693d.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Resort na Talaga/maxresdefault_67579e2c26b18.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Resort na Talaga/resort-sea_67579e2c26c5f.jpg', '../../businessowner/roomImages/Mario Tupar Resort/Resort na Talaga/wallpaper2_67579e4985c28.jpg', NULL, NULL, '23:48:00', '23:48:00');
...
(29, 54, 'eaanives04@gmail.com', '$2y$10$WczCEU1WwHNdF/bFXfEVEuQ9WaOgQYNOR/d4U089m30Cw.c7/MydO', '2024-12-10 14:29:00', 1);
...
(30, 52, 2, 119, 'Jordan Rae Marabe, John Rev Baliton', 'Male, Female', 'Other City/Municipality, Foreign Country', '2024-12-10 10:17:47', 2, 1, 1, 0, 1, 0, 1, 'Pending'),
(31, 53, 2, 119, 'Jordan Rae Marabe', 'Male', 'Other City/Municipality', '2024-12-10 11:59:31', 1, 1, 0, 0, 1, 0, 0, 'Pending'),
(32, 54, 2, 119, 'John Smith, Alpha Trost, Beta Max, Gamma Bunta, Delta Starr', 'Male, Male, Male, Female, Female', 'Other Province, This City/Municipality, Other City/Municipality, Other Province, Foreign Country', '2024-12-10 14:35:11', 5, 3, 2, 1, 1, 2, 1, 'Pending'),
(33, 53, 1, 119, 'Jordan Rae Marabe, John Rev Baliton', 'Male, Female', 'This City/Municipality, Other Province', '2024-12-11 02:07:12', 2, 1, 1, 1, 0, 1, 0, 'Pending');
...
(52, 'Kuya Jason', 'kuyajason00@shurua.xyz', '+638937249872', '1212 Street', 'Other City/Municipality', 'Female', 'Postal ID', '../../user/userID/Jason/Jason_52_front.jpg', NULL, '2024-11-18 01:14:43'),
...
(54, 'John Smith', 'eaanives04@gmail.com', '+639917847770', '123 St., Brgy. Barangay, Municipality City, Province province', 'Other Province', 'Male', 'national_id', '../../user/userID/Smith/Smith_54_front.jpg', '../../user/userID/Smith/Smith_54_back.jpg', '2024-12-10 14:29:00');
...
--
ALTER TABLE `payment_methods`
  MODIFY `paymentMethodID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `reservations`
  MODIFY `revID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `room_facilities`
  MODIFY `FacilityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `useraccount`
  MODIFY `userAccID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `userdemographics`
--
ALTER TABLE `userdemographics`
  MODIFY `userdemogId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `userpayment`
--
ALTER TABLE `userpayment`
  MODIFY `userpayID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `roominfotable`
  ADD CONSTRAINT `roominfotable_ibfk_1` FOREIGN KEY (`BusinessInfoID`) REFERENCES `businessinformationform` (`BusinessInfoID`);
...
--
-- Constraints for table `userdemographics`
--
ALTER TABLE `userdemographics`
  ADD CONSTRAINT `userdemographics_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`userId`),
  ADD CONSTRAINT `userdemographics_ibfk_2` FOREIGN KEY (`roomID`) REFERENCES `roominfotable` (`roomID`),
  ADD CONSTRAINT `userdemographics_ibfk_3` FOREIGN KEY (`BusinessInfoID`) REFERENCES `businessinformationform` (`BusinessInfoID`);
