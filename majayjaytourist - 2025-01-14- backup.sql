...
(187, 27, 72, 'John Doe', '123 St., Brgy. Barangay, Municipality City, Province province', 'eaanives04@gmail.com', '+639065417074', '2025-01-21', '2025-01-22', 'REF-XTB5J8', '2025-01-13 18:26:16', 'Accepted', NULL),
(191, 27, 71, 'Michelle Molina', 'Sta monica, San Pablo City, laguna', 'michellepriamolina2016@gmail.com', '+639667742616', '2025-01-15', '2025-01-16', 'REF-4B8DDW', '2025-01-14 11:26:13', 'Canceled', '.');
...
(48, 73, 'jordanmarabe@shurua.xyz', '', '2025-01-14 03:16:02', 0);
...
(73, 'Jordan Marabe', 'jordanmarabe@shurua.xyz', '+630849120481', '1212 Street Barangay III, Alaminos Laguna', 'Other City/Municipality', 'Male', 'Student ID', 'Marabe_73_front.webp', NULL, '2025-01-14 03:16:02');
...
--
ALTER TABLE `payment_methods`
  MODIFY `paymentMethodID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `reservations`
  MODIFY `revID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
...
--
ALTER TABLE `useraccount`
  MODIFY `userAccID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `userdemographics`
--
ALTER TABLE `userdemographics`
  MODIFY `userdemogId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;
