...
<body>
    <main class="content">
        ...
        <section class="bg-light rounded-top rounded-top-3" id="destination-information">
            <div class="container-fluid">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-9 col-lg-10 col-12 mt-3">
                    ...
                    <div class="col-xl-9 col-lg-10 col-12 mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row d-flex justify-content-center">
                                    ...
                                    <div class="col-11 p-2 border rounded bg-secondary-subtle">
                                        ...
                                        <div class="row g-2 d-flex justify-content-start">
                                            ...
                                            ?>
                                                    <div class="col-lg-4 col-md-6">
                                                        <p class="dm-sans-text"><i class="bi bi-info-circle-fill me-1 text-success"></i><?php echo htmlspecialchars($description); ?></p>
                                                    </div>
                                            <?php
                                                endif;
                                            endforeach;
