...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2024 at 04:54 AM
...
(21, 48, 'jordanao98@shurua.xyz', '', '2024-11-13 00:12:11', 1),
(22, 48, 'jordanao98@shurua.xyz', '$2y$10$ExmqYhyXyNt/KJ1dFr/diuT74jq75Km4QunnUEZqlJvRxpdydKkiq', '2024-11-13 00:12:36', 1),
(23, 49, 'badingksu78@shurua.xyz', '$2y$10$o9RPiZTPcKPY66w72X7FiuijKoHI//sY4UyFT.3lyJbkBqIp3eDZS', '2024-11-13 00:17:34', 1),
(24, 50, 'poknaykjsd87@shurua.xyz', '', '2024-11-14 16:37:49', 0),
(25, 51, 'kjasd897@shurua.xyz', '', '2024-11-14 16:39:42', 0);
...
--
ALTER TABLE `account`
  MODIFY `AccountID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `barangay_accounts`
  MODIFY `barangayId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `bownerdemographics`
--
ALTER TABLE `bownerdemographics`
  MODIFY `bOwnerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `businessapplicationform`
--
ALTER TABLE `businessapplicationform`
  MODIFY `ApplicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;

--
-- AUTO_INCREMENT for table `businessinformationform`
--
ALTER TABLE `businessinformationform`
  MODIFY `BusinessInfoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
...
--
ALTER TABLE `useraccount`
  MODIFY `userAccID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
