...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2024 at 02:22 PM
...
INSERT INTO `useraccount` (`userAccID`, `userID`, `email`, `passcode`, `created_at`) VALUES
(11, 38, 'manepapcordn87@shurua.xyz', '$2y$10$GDeFJCCsXo3VncRVi.JagusfKu0HKY.o.0ntegCI0nss/83Xtt1nK', '2024-11-12 13:11:33');
...
(38, 'Mane Pakcord', 'manepapcordn87@shurua.xyz', '+637126317286', 'kjsadhaskjhdasda', 'otherCity', 'male', 'driver_license', '../../user/userID/Pakcord/Pakcord_38_front.jpg', NULL, '2024-11-12 13:10:31');
...
--
ALTER TABLE `businessapplicationform`
  MODIFY `ApplicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=128;

--
-- AUTO_INCREMENT for table `businessinformationform`
--
ALTER TABLE `businessinformationform`
  MODIFY `BusinessInfoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
...
--
ALTER TABLE `useraccount`
  MODIFY `userAccID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
