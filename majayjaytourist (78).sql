...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2024 at 07:53 AM
...
(5, 1, 52, 'Kuya Jason', '1212 Street', 'kuyajason00@shurua.xyz', '+638937249872', '2024-12-12', '2024-12-13', 'REF-8ELH7L', '2024-12-10 09:44:13', 'Pending'),
(6, 2, 52, 'Kuya Jason', '1212 Street', 'kuyajason00@shurua.xyz', '+638937249872', '2024-12-11', '2024-12-12', 'REF-CQ1494', '2024-12-10 09:50:56', 'Accepted');
...
(5, 52, 1, 119, 'John Rev Baliton', 'Male', 'Other City/Municipality', '2024-12-10 01:44:13', 1, 1, 0, 0, 1, 0, 0, 'Pending'),
(6, 52, 2, 119, 'Jordan Rae Marabe', 'Male', 'This City/Municipality', '2024-12-10 01:50:56', 1, 1, 0, 1, 0, 0, 0, 'Pending');
...
(5, 1, 119, 52, 0, '../../businessowner/userPaymentProof/Graduation new honors_page-0001.jpg', '4523 523 532525');
...
--
ALTER TABLE `userdemographics`
  MODIFY `userdemogId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `userpayment`
--
ALTER TABLE `userpayment`
  MODIFY `userpayID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
