...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2024 at 02:14 PM
...
(52, 109, 'iq7eej58@duckmail.club', '$2y$10$96589gBNNcfQTKPoFi1NVOszATQYhm2IvwSoDHxsgVqC.EK.1aAhK', 0, '2024-10-22 07:09:57', '2024-10-14 07:26:15', 'subadmin', 'Active', 0);
...
(35, 10, 'Kalta, Kalta', 'Male, Male', 'This City/Municipality, Foreign Country', '2024-10-29 12:29:36', 2, 2, 0, 1, 0, 0, 1),
(36, 10, 'Kanluaran Silang, Manobo Triber', 'Male, Fema', 'Foreign Country, Other Province', '2024-10-29 13:13:02', 2, 1, 1, 0, 0, 1, 1);
...
--
ALTER TABLE `barangay_accounts`
  MODIFY `barangayId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `demographics`
  MODIFY `demogId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
